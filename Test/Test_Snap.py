...
Snap_range = range(10, 230, 30)

results = {}

total_steps = len(Snap_range) * computer_num
progress_bar = tqdm(total=total_steps, desc='Processing Snap values', unit='steps')
...
for Snap in Snap_range:
    ...
    print(f"Snap = {Snap}")
    print("Proposed_Model:", results[Snap]['Model'])
    print("DeepCNN:", results[Snap]['DeepCNN'])
    print("CV:", results[Snap]['CV'])
    print("Music:", results[Snap]['Music'])
    print("CBF:", results[Snap]['CBF'])
    print("MVDR:", results[Snap]['MVDR'])
    print("PM:", results[Snap]['PM'])
    print("SS_Music:", results[Snap]['SS_Music'])
    print("Toeplitz_Music:", results[Snap]['Toeplitz_Music'])
    print()

progress_bar.close()

df = pd.DataFrame.from_dict(results, orient='index')
df.to_csv('Snap20to200_SNR0_-10.49_10.62.csv')
